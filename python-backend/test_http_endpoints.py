...
JWT_SECRET = "super_secret_jwt_key_enterprise_grade_aaas_platform_2026"
...
def run_http_tests():
    ...
    # 3. Test 404 Not Found on Bogus or Cross-Tenant Order Lookups
